...
import ImageDraw
import numpy as np
# from PIL import Image, ImageDraw  # If in doubt...


def print_usage():
    print('parse_region.py -i <image file> -x <region file> -m <output mask> -o <text mask>')


try:
    opts, args = getopt.getopt(sys.argv[1:], "i:x:o:m:")
