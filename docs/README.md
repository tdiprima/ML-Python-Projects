...
```sh
sudo vim Frameworks/Python.framework/Versions/3.5/lib/python3.5/site-packages/notebook/static/custom/theme-dark.css
sudo vim Frameworks/Python.framework/Versions/3.5/lib/python3.5/idlelib/config-main.def
